...
## source: https://github.com/drdaffey/debinst/blob/master/debinst.sh
## purpose: install deb packages on voidlinux
## install debian packages on any distro

## usage:  debinst.sh install package.deb
