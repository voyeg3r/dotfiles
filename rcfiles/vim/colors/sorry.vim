" Vim color file
" sorry
" Created by Sergio Araujo with ThemeCreator (https://github.com/mswift42/themecreator)
...
let s:bg3="#2a2a2a"
let s:bg4="#3e3e3e"
let s:keyword="#ffe50d"
let s:builtin="#ff004e"
let s:const= "#fbf7f5"
let s:comment="#68adc3"
let s:func="#ff6000"
let s:str="#e1fffb"
let s:type="#f4a55a"
let s:var="#fd00cc"
