...
#
# Copyright May 2nd 2012 - MB <http://somethingididnotknow.wordpress.com>
#
...
# source: http://somethingididnotknow.wordpress.com/2012/05/02/fix-subtitles-offset-with-python/
#
